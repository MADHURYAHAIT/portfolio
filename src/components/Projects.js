        ...
        <div class="container dabba">
            ...
            <div class="col- col-sm-9 col-md-6 col-lg-6 col-xl-4" data-aos="fade-up">
                ...
                <div class="card mb-4">
                    ...
                    <img src="./img/docuscholar.png" alt="NutriSync" />
                    <a href="#!">
                    ...
                    {/*Title*/}
                    <strong className='text-altdeep'><h1>DocuScholar</h1></strong>
                    {/*Text*/}
                    <p class="card-text">MERN Stack Chat Web App with a chatbot which gives answers based on pdf input.</p>
                    {/* Provides extra visual weight and identifies the primary action in a set of buttons */}
                    <a href="https://github.com/MADHURYAHAIT/DocuScholar"> <button type="button" class="category-btn btn-light-blue btn-md"><LuEye className='icon'/></button></a>
                   <a href="https://github.com/MADHURYAHAIT/DocuScholar"> <button href="#" type="button" class="category-btn btn-light-blue btn-md"><IoCodeSlashSharp className='icon'/></button></a>
